...
void VulkanGraphicsPipelineCreate(VulkanContext* context) {
    ...
    pipelineLayoutInfo.pSetLayouts = &context->graphicsPipeline.descriptorSetLayout;

    if (vkCreatePipelineLayout(context->device.logicalDevice, &pipelineLayoutInfo, nullptr, &context->graphicsPipeline.pipelineLayout) != VK_SUCCESS) {
    ...
    pipelineInfo.layout = context->graphicsPipeline.pipelineLayout;
    pipelineInfo.renderPass = context->renderpass;
    pipelineInfo.subpass = 0;
    pipelineInfo.basePipelineHandle = VK_NULL_HANDLE;

    if (vkCreateGraphicsPipelines(context->device.logicalDevice, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &context->graphicsPipeline.handle) != VK_SUCCESS) {
...
void VulkanPipelineDestroy(VulkanContext* context, VulkanPipeline& pipeline) {
    if (context->graphicsPipeline.handle != VK_NULL_HANDLE) {
    ...
    if (context->graphicsPipeline.pipelineLayout != VK_NULL_HANDLE) {
